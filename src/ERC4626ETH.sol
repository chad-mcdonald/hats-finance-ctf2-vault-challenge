...
abstract contract ERC4626ETH is Ownable, ERC20 {
    ...
    function convertToShares(uint256 assets) public view virtual returns (uint256 shares) {
        return assets; //@audit always 1:1 shares:assets
    }
    ...
    function _withdraw(
        ...
        uint256 excessETH = totalAssets() - totalSupply(); // @audit need TA to be +1 more than TS, are always minted 1:1
...
//   vault shares after kill:  1000000000000000000
//   vault assets after kill:  2000000000000000000

//   vault shares after mint:  2000000000000000000
//   vault assets after mint:  3000000000000000000

//   vault shares after withdraw:  1000000000000000000
//   vault assets after withdraw:  0